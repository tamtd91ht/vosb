package com.vosb.gateway.server.http.admin;

import com.vosb.gateway.server.auth.JwtAuthHandler;
import com.vosb.gateway.server.http.admin.auth.AuthHandlers;
import com.vosb.gateway.server.http.admin.carrier.CarrierHandlers;
import com.vosb.gateway.server.http.admin.channel.ChannelHandlers;
import com.vosb.gateway.server.http.admin.channel.ChannelRateHandlers;
import com.vosb.gateway.server.http.admin.partner.PartnerRateHandlers;
import com.vosb.gateway.server.http.admin.message.MessageHandlers;
import com.vosb.gateway.server.http.admin.partner.ApiKeyHandlers;
import com.vosb.gateway.server.http.admin.partner.PartnerHandlers;
import com.vosb.gateway.server.http.admin.partner.SmppAccountHandlers;
import com.vosb.gateway.server.http.admin.route.RouteHandlers;
import com.vosb.gateway.server.http.admin.session.SessionHandlers;
import com.vosb.gateway.server.http.admin.stats.StatsHandlers;
import com.vosb.gateway.server.http.admin.user.UserHandlers;

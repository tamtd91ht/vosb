    ...
    <div className="max-w-3xl space-y-6">
      ...
      <Section title="1. Tổng quan">
        <div className="text-sm text-slate-600 space-y-2">
          <p>VOSB Gateway cung cấp 2 phương thức gửi tin nhắn:</p>
...
TS=$(date +%s)
BODY='{"source_addr":"VOSBSMS","dest_addr":"84901234567","content":"Xin chao tu VOSB Gateway!"}'
...
curl -X POST https://gw.tkc.vn/api/v1/messages \\
  ...
  "created_at": "2026-04-28T08:30:00Z"
        ...
        <div className="space-y-1.5">
          ...
          <CodeBlock language="json" code={`{
  "source_addr": "VOSBSMS",        // Sender ID (≤11 ký tự alpha hoặc ≤15 số)

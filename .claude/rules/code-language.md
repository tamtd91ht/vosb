...
- **Tài liệu** trong `smpp/docs/`: tiếng Việt, giữ nguyên thuật ngữ kỹ thuật tiếng Anh (Spring Boot, Vert.x, RabbitMQ, dispatcher, route, partition, ...).
...
- **ADR**: tiếng Việt (xem template trong `smpp/docs/decisions.md`).

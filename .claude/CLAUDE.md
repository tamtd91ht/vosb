...
- `smpp/backend/`  — Spring Boot 3 + jSMPP, Gradle multi-module (`core`, `smpp-server`, `worker`)
...
- **BE**: Spring Boot 3, Java 21, jSMPP, Spring Data JPA + Flyway, Spring AMQP, Lettuce
...
3. `smpp/docs/backend.md`        — Gradle module, SMPP server, worker, dispatcher
